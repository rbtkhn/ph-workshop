...
It should guide corpus design, review priorities, media-pack planning, contributor onboarding, and future `civ-ph` package work. Public audience numbers are approximate and should be refreshed before publication or fundraising use.
...
- clear distinction between transcript, commentary, `civ-ph`, media packs, and quote-grade claims
...
- media packs as what-to-see-before-reading aids
...
- Build media packs for orientation, not proof.
