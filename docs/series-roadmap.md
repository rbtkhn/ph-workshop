...
4. Define and pass the publication gate before updating the `ph-civ` public edition or context pack.
5. Interviews
6. Essays
...
- Keep `ph-civ` context-pack population paused until `pilot-001` passes the export scaffold and publication gate.
