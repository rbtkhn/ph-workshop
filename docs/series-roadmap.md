...
| Secret History | Limited literary subset present | `sh-11`, `sh-16`, `sh-17`, and `sh-18` are routed as literary/imagination support nodes; the full Secret History series remains pending. |
...
- Treat the Secret History subset as literary support for Homer-to-Tolstoy, not as a full public series rollout.
