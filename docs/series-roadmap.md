...
| Civilization | First seventeen-chapter spine present | Volume II commentary template is present in `book/volume-ii/`; `civ-01` is the calibrated pilot, and `civ-02` through `civ-17` are in review after initial commentary analysis. |
| PH-CIV | Seed plus spine placements present | Calibrated placements exist for `civ-01`, `geo-05`, `geo-07`, and `geo-12`; `civ-02` through `civ-17` are in review. |
...
- Treat Civilization as the next active batch family, with a public first seventeen-chapter spine now in review from `civ-02` through `civ-17`.
