...
The active typed registries are:
...
Prediction tracking should be core but scoped: prominent for Geo-Strategy and current-events claims, lighter for non-forecast corpora.
