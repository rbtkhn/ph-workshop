...
The first twenty-eight-chapter spine lives in `civ-01/` through `civ-28/`. `civ-01` is the calibrated pilot, and `civ-02` through `civ-28` are in review after initial commentary analysis.
