...
The first thirty-nine-chapter spine lives in `civ-01/` through `civ-39/`. `civ-01` is the calibrated pilot, and `civ-02` through `civ-39` are in review after initial commentary analysis.
