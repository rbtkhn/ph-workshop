...
The first thirty-four-chapter spine lives in `civ-01/` through `civ-34/`. `civ-01` is the calibrated pilot, and `civ-02` through `civ-34` are in review after initial commentary analysis.
