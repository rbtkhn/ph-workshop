...
For calibrated chapter placement, use the derived PH-CIV corpus in [corpus/ph-civ/](../../corpus/ph-civ/). Commentary pages should remain focused on the source-backed layer structure.
