...
The first twenty-five-chapter spine lives in `civ-01/` through `civ-25/`. `civ-01` is the calibrated pilot, and `civ-02` through `civ-25` are in review after initial commentary analysis.
