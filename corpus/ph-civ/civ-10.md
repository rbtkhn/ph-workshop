...
source_corpus_path: corpus/civilization/civ-10.md
source_chapter_path: book/volume-ii/civ-10/civ-10-transcript.md
...
- The trial of Socrates links democracy, legitimacy, and philosophical dissent.
...
Return here when later chapters depend on philosophy as a break from inherited appearances, civic consensus, or democratic judgment. For close reading, move from this placement entry to the source transcript, then use the companion commentary for source-backed claims, concepts, predictions, and limits.
