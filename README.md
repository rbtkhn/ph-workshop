...
- the first Civilization spine from `civ-01` through `civ-28`, with `civ-02` through `civ-28` in review
...
- [corpus/civilization/](corpus/civilization/) - Civilization corpus pointers for `civ-01` through `civ-28`
...
- [book/volume-ii/](book/volume-ii/) - Civilization chapter scaffold and first twenty-eight-chapter spine
