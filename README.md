...
The first version established the public contract before importing real corpus items. The first Geo-Strategy batch is now present as transcript-first chapter pairs plus corpus pointers for `geo-01` through `geo-06`.
...
- the first public Geo-Strategy chapter files for `geo-01` through `geo-06`
