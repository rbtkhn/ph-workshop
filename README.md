...
- the first Civilization spine from `civ-01` through `civ-46`, with `civ-02` through `civ-46` in review
...
- [corpus/civilization/](corpus/civilization/) - Civilization corpus pointers for `civ-01` through `civ-46`
...
- [book/volume-ii/](book/volume-ii/) - Civilization chapter scaffold and first forty-six-chapter spine
